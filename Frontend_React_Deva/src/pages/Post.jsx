...
import { DialogCreateUpdate, DialogDelete } from "../components/DialogPost";
...
export default function Post() {
  ...
  const header = (
    <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
      <h4 className="m-0 text-xl">Administrar Noticias</h4>
  ...
  return (
    <div>
      ...
      <DialogCreateUpdate
        ...
        label_01="Nombre"
        id_01="estado"
        value_01={product.nombre}
        onChange_01={(e) => onInputChange(e, "nombre")}
        className_01={classNames({ "p-invalid": submitted && !product.nombre })}
        msgRequired_01={
          submitted &&
          !product.nombre && (
