...
const Sidebar = () => {
    ...
    return (
        <>
            <aside
                className="ml-[-100%] fixed z-50 top-0 pb-3 px-5 flex flex-col justify-between h-screen border-r bg-white md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[18%] 2xl:w-[15%]">
                <div>
                        ...
                        <a href="#" title="home">
                            <div className="flex flex-row items-center justify-center">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-lg font-bold italic"> DEVAPerú SAC</span>
                    ...
                    <div className="text-center">
                        <img className="mx-auto rounded-full object-cover" style={{ width: 140, height: 140 }}
                            src="/img/fibras.jpg" />
                        <h5 className="mt-4 text-lg font-semibold text-gray-600 ">Manuel Chunca Mamani</h5>
                        ...
                        {SidebarData.map((item, index) => {
                            return (
                                <div key={index} className={item.cName}>
                                    <Link to={item.path}>
                                        <SidebarLink active={activeRoute === item.path ? true : false} icon={item.icon} onClick={() => handleItemClick(item.path)}>
                                            {item.title}
                                        </SidebarLink>
                                    </Link>
                                </div>
                    ...
                    <div className="lg:px-4 pl-0 pr-3 flex items-center justify-between">
                        <div hidden className="bg-grey-light w-48 rounded-md lg:block">
                            <div className="flex items-center">
                                <a href="/" className="text-black ease-in-out hover:text-gray-600">
                                    <i className="pi pi-home"></i></a>
                        ...
                        <button className="h-16 border-r lg:hidden bg-gray-100 focus:bg-gray-100 active:bg-gray-200 flex justify-center" style={{ width: 55 }}>
                            <i className="pi pi-bars my-auto"></i>
                        </button>
                        <div className="flex space-x-3">
                            <button
                                className="h-10 px-2 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
