      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <span style={{ fontSize: 16, fontStyle: "italic", marginTop: -5 }}>
              {" "}
              SAC{" "}
            </span>
          </div>
        ...
        <div className="mx-4 px-4 sm:px-6 lg:px-4 py-1">
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <ul className="hidden space-x-4 md:-my-px md:ml-5 md:flex space-y-1 px-2 py-4 text-sm font-medium text-gray-700 items-center">
                {NavbarData.map((item, index) => {
                  return (
                    <div key={index} className={item.cName}>
                      <Link to={item.path}>
            ...
            <div className="flex items-center">
              ...
              <div className="sm:flex sm:items-center mx-2">
                <span className="inline-flex">
                  <a
                    href="/logindev"
                    className="h-10 px-3 py-2 inline-flex items-center rounded-lg border bg-gray-100 focus:bg-gray-100 active:bg-gray-200"
                  >
