...
const Table = (props) => {
  ...
  const { refToast, left, right, refDT, value, selection, onSelectionChange, dataKey, globalFilter, header, nombre_01, header_01, nombre_02, header_02, nombre_03, header_03, nombre_04, header_04, nombre_05, header_05, nombre_06, header_06, nombre_07, header_07, nombre_08, header_08, nombre_09, header_09, nombre_10, header_10, body } = props;
